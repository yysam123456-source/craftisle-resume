	...
	return (
		<DialogContent>
			<DialogHeader>
				...
				<DialogDescription>
					<Trans>
						Continue where you left off by importing an existing resume you created using Craftisle Resume or any another
						resume builder. Supported formats include PDF, Microsoft Word, as well as JSON files from Craftisle Resume.
					</Trans>
				</DialogDescription>
			</DialogHeader>
										...
										options={[
											{
												...
												label: t({
													comment: "Import source option for current Craftisle Resume JSON format",
													message: "Craftisle Resume (JSON)",
												}),
											},
											{
												value: "reactive-resume-v4-json",
												label: t({
													comment: "Import source option for legacy Craftisle Resume v4 JSON format",
													message: "Craftisle Resume v4 (JSON)",
												}),
											},
											{
