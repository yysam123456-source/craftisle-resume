	...
	<section className="relative overflow-hidden bg-linear-to-b from-background via-primary/2 to-background py-24">
		...
		<div className="container relative px-8">
			...
			>
				...
				>
					<Trans>Support Craftisle Resume</Trans>
				</m.h2>
				...
				>
					<Trans>
						Craftisle Resume is a free and open-source project, built with love and maintained by me and a community of
			...
			>
				...
				<Button
					...
					className="h-11 gap-2 px-6"
					render={
						<a href="https://github.com/sponsors/CraftisleTeam" target="_blank" rel="noopener noreferrer">
