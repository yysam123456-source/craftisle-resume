...
const getResourceLinks = (): FooterLinkItem[] => [
	{ url: "https://docs.resume.craftisle.com", label: t`Documentation` },
	{ url: "https://opencollective.com/craftisle-resume/donate", label: t`Sponsorships` },
	{ url: "https://github.com/yysam123456/craftisle-resume", label: t`Source Code` },
	{ url: "https://docs.resume.craftisle.com/changelog", label: t`Changelog` },
];

const getCommunityLinks = (): FooterLinkItem[] => [
	{ url: "https://github.com/yysam123456/craftisle-resume/issues", label: t`Report an issue` },
	{ url: "https://crowdin.com/project/craftisle-resume", label: t`Translations` },
	{ url: "https://reddit.com/r/craftisleresume", label: t`Subreddit` },
	{ url: "https://discord.gg/aSyA5ZSxpb", label: t`Discord` },
];

const socialLinks: SocialLink[] = [
	{ url: "https://github.com/yysam123456/craftisle-resume", label: t`GitHub`, icon: GithubLogoIcon },
	{ url: "https://linkedin.com/in/craftisle", label: t`LinkedIn`, icon: LinkedinLogoIcon },
	{ url: "https://x.com/craftisle", label: t`X (Twitter)`, icon: XLogoIcon },
];
			...
			<div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
				...
				<div className="space-y-4 sm:col-span-2 lg:col-span-1">
					...
					<div className="space-y-2">
						<h2 className="font-semibold text-lg tracking-tight">Craftisle Resume</h2>
