...
const getFaqItems = (): FAQItemData[] => [
	{
		question: t`Is Craftisle Resume really free?`,
		answer: t`Yes! Craftisle Resume is completely free to use, with no hidden costs, premium tiers, or subscription fees. It's open-source and will always remain free.`,
	},
	{
		question: t`How is my data protected?`,
		answer: t`Your data is stored securely and is never shared with third parties. You can also self-host Craftisle Resume on your own servers for complete control over your data.`,
	},
	{
	...
	{
		question: t`Is Craftisle Resume available in multiple languages?`,
		answer: (
			<Trans>
				Yes, Craftisle Resume is available in multiple languages. You can choose your preferred language in the settings
	...
	{
		question: t`What makes Craftisle Resume different from other resume builders?`,
		answer: t`Craftisle Resume is open-source, privacy-focused, and completely free. Unlike other resume builders, it doesn't show ads, track your data, or limit your features behind a paywall.`,
	},
	{
