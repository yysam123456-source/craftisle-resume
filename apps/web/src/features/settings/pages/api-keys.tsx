			...
			<div className="flex items-start gap-4 rounded-md border bg-popover p-6">
				...
				<div className="flex-1 space-y-2">
					...
					<p className="text-muted-foreground leading-relaxed">
						<Trans>
							Explore the API documentation to learn how to integrate Craftisle Resume with your applications. Find
					...
					<Button
						...
						nativeButton={false}
						render={
							<a href="https://docs.resume.craftisle.com/api-reference" target="_blank" rel="noopener noreferrer">
								<LinkSimpleIcon />
