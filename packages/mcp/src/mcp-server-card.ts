...
export function buildMcpServerCard(appVersion: string) {
	const tools = [
		...
		},
		{
			...
			description: [
				...
				"Analyses are created from the Craftisle Resume web app AI flow, not from MCP.",
		...
		},
		{
			...
			title: "Import Resume",
			description: [
				"Create a new resume from a full ResumeData JSON object (e.g. an exported file from Craftisle Resume).",
	...
	return {
		...
		serverInfo: {
			...
			version: appVersion,
			title: "Craftisle Resume",
			websiteUrl: "https://resume.craftisle.com",
			description:
				"Craftisle Resume is a free and open-source resume builder. Use this MCP server to interact with your resume using an LLM of your choice.",
			icons: [
				{ src: "https://resume.craftisle.com/icon/light.svg", mimeType: "image/svg+xml", theme: "light" as const },
				{ src: "https://resume.craftisle.com/icon/dark.svg", mimeType: "image/svg+xml", theme: "dark" as const },
			],
		},
		tools,
		prompts,
