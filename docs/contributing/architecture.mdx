...
description: "Understand the Craftisle Resume monorepo, runtime boundaries, and package ownership model"
---

Craftisle Resume is a pnpm/Turborepo monorepo. The product runs as one deployed Node.js process, while the source is split into a full-stack web app, a server adapter, and focused internal packages.
