...
description: "Set up a local development environment for Craftisle Resume"
---
...
This guide walks you through setting up Craftisle Resume for local development. Whether you're contributing to the project or customizing it for your needs, these steps will get you up and running.
...
<Steps>
  ...
  <Step title="Start the Development Server">
    ...
    Your local Craftisle Resume instance will be available at [http://localhost:3000](http://localhost:3000).
  </Step>
</Steps>
...
Craftisle Resume uses [Lingui](https://lingui.dev/) for internationalization.
...
// For JSX content
<Trans>Welcome to Craftisle Resume</Trans>;
```
...
<CardGroup cols={2}>
  ...
  <Card title="GitHub Repository" icon="github" href="https://github.com/yysam123456/reactive-resume">
