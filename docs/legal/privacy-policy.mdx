...
description: "How Craftisle Resume handles personal data, cookies, uploads, and printing."
---

## Overview

This Privacy Policy explains how **Craftisle Resume** (the “Service”) collects, uses, stores, and shares information when you use it.

Craftisle Resume is open-source and can be operated in different ways (for example, by the official hosted service, or by an organization/self-hosted deployment). The specific data controller for your use depends on who operates the instance you are using.

- **Service Operator**: Craftisle Team
- **Contact**: hello@yysam123456.com
- **Service URL**: https://resume.craftisle.com
...
<Note>
  **Note for self-hosted deployments:** If you are using the official hosted service at <code>resume.craftisle.com</code>, the
  project's published support contact is <code>hello@yysam123456.com</code>. Replace the placeholders above with the
...
Craftisle Resume is a resume builder that lets you:
