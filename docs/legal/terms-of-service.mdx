...
description: "Terms and conditions for using Craftisle Resume, including accounts, public resumes, uploads, and exports."
---

## Agreement

These Terms of Service (the “Terms”) govern your access to and use of **Craftisle Resume** (the “Service”). By using the Service, you agree to these Terms.
...
<Note>
  ...
  hosted service at <code>resume.craftisle.com</code>, the project's published support contact is{" "}
  <code>hello@yysam123456.com</code>.
</Note>
...
Craftisle Resume is a resume builder that allows you to create, store, and share resumes, upload related assets, and export/print resumes (including generating PDFs and screenshots).
...
Craftisle Resume is open-source software licensed under the **MIT License**. These Terms govern **use of the Service**, not the open-source license for the code.
