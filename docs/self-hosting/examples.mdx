...
<Info>
  **Help others by sharing your setup!** If you have a working configuration that isn't covered here, I'd love to
  include it. Simply [open a pull request](https://github.com/yysam123456/reactive-resume) with your example added to
...
This example uses [Traefik](https://traefik.io/) as a reverse proxy with automatic SSL certificate management via Let's Encrypt. Only the Craftisle Resume app is exposed through Traefik—Postgres remains on an internal network.
...
services:
  ...
  reactive_resume:
    ...
    deploy:
      ...
      labels:
        - "traefik.enable=true"
        - "traefik.http.routers.app.rule=Host(`resume.craftisle.com`)"
...
To contribute, [open a pull request](https://github.com/yysam123456/reactive-resume) with your example added to this page. Include:
