---
title: "Introduction"
description: "Welcome to the documentation for Craftisle Resume, a free and open-source resume builder that simplifies the process of creating, updating, and sharing your resume."
---

<Frame>
  <img src="/images/getting-started/banner.webp" alt="Craftisle Resume Banner" />
</Frame>

## What is Craftisle Resume?

**Craftisle Resume** is a free and open-source resume builder designed to simplify the process of creating, updating, and sharing your professional resume. Built with privacy as a core principle, it gives you complete control over your data while providing a powerful, modern experience.
...
<Frame>
  <img src="/images/getting-started/infographic.webp" alt="An infographic of the major features of Craftisle Resume" />
</Frame>

<AccordionGroup>
	<Accordion title="Completely Free & Open Source" icon="code-branch">
		Craftisle Resume is licensed under MIT. You can use it for free, modify it, and even host your own instance. The
		entire codebase is available on [GitHub](https://github.com/yysam123456/reactive-resume).
	</Accordion>
    ...
    <Accordion title="Multi-language Support" icon="globe">
    	Craftisle Resume supports multiple languages, making it accessible to users worldwide. Contribute translations to
    ...
    <Accordion title="Self-hosting Ready" icon="server">
    	Deploy your own instance of Craftisle Resume using Docker. Keep complete control over your data and infrastructure.
    </Accordion>
...
Whether you want to use our hosted version or run your own instance, Craftisle Resume has got you covered.
...
<CardGroup cols={2}>
  ...
  <Card title="Development Setup" icon="code" href="/contributing/development">
    Set up a local development environment to contribute or customize Craftisle Resume.
  </Card>
</CardGroup>

## Tech Stack

Craftisle Resume is built with modern web technologies:
...
<CardGroup cols={2}>
  <Card title="GitHub" icon="github" href="https://github.com/yysam123456/reactive-resume">
  ...
  <Card title="Sponsor" icon="heart" href="https://opencollective.com/reactive-resume/donate">
    Support the development and long-term sustainability of Craftisle Resume.
  </Card>
</CardGroup>

<Note>
  **Need help?** Feel free to reach out via [email](mailto:hello@yysam123456.com) or open an issue on GitHub.
</Note>
