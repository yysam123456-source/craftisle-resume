---
title: "Quickstart"
description: "Get started with Craftisle Resume in minutes — use our hosted version or deploy your own instance"
---

## Options

Craftisle Resume offers flexibility in how you want to use it. Choose the option that best fits your needs:
...
The easiest way to use Craftisle Resume is through our cloud version at [resume.craftisle.com](https://resume.craftisle.com). **This service is completely free and will always remain free.**

<Steps>
	<Step title="Create an Account">
		Visit [resume.craftisle.com](https://resume.craftisle.com) and sign up for free using your email, or sign in with your GitHub or Google
		account.
	</Step>
...
For users who prefer complete control over their data, you can deploy Craftisle Resume on your own infrastructure using Docker.
...
<Steps>
	<Step title="Clone the Repository">
		```bash
		git clone https://github.com/yysam123456/reactive-resume.git
		cd reactive-resume
		```
	</Step>
...
```
	...
	- **Redis** — Required for the AI Agent workspace
    	...
    	- **Craftisle Resume** — The main application
    </Step>

    <Step title="Access Your Instance">
    	Once all services are running, access your Craftisle Resume instance at:
...
| `reactive_resume` | 3000 | The main Craftisle Resume application                 |

<Note>
  Saved AI provider management requires `ENCRYPTION_SECRET`, and the AI Agent workspace requires both `REDIS_URL` and
  `ENCRYPTION_SECRET`. Other Craftisle Resume features can run without them. Agent attachments and other private objects
...
| `APP_URL`      | Public URL of your Application | `https://resume.craftisle.com`                   |
...
<CardGroup cols={2}>
  <Card title="Development Setup" icon="code" href="/contributing/development">
    Set up a development environment to contribute or customize Craftisle Resume.
  </Card>
...
<Note>
  **Having trouble?** Check our [GitHub Issues](https://github.com/yysam123456/reactive-resume/issues) or reach out via
  [email](mailto:hello@yysam123456.com).
</Note>
