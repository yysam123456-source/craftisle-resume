...
description: "Automate resume workflows in Craftisle Resume with API keys, the Patch API, the MCP server, AI agent tools, and the JSON resume schema."
---

Craftisle Resume supports resume automation through authenticated API access and an MCP server that lets compatible tools list, read, create, import, duplicate, and patch resumes.
