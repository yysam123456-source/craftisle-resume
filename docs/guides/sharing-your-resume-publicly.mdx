...
<Step title="Toggle 'Allow Public Access'">
  ...
  <Step title="Copy your public URL">
    ...
    ```
    https://resume.craftisle.com/{username}/{slug}
    ```
...
2. **No account required** - Visitors don't need a Craftisle Resume account to view or download your resume
...
When your resume is public, Craftisle Resume tracks public views. This helps you understand whether people are opening the link you shared.
...
<Accordion title="Can I see who viewed my resume?">
  No, Craftisle Resume tracks public view counts, not the identity of visitors. This protects visitor privacy.
</Accordion>
