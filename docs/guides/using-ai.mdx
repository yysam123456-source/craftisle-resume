...
description: "Learn how to configure an AI provider for AI-assisted features in Craftisle Resume."
---

Craftisle Resume uses AI providers for features such as resume analysis, AI-assisted resume changes, AI agent drafts, and PDF or Word imports.
...
| **API Key** | The key Craftisle Resume should use when sending AI requests to that provider. |
...
<Steps>
  <Step title="Click Test">
    Craftisle Resume sends a small request to verify the provider, model, base URL, and key.
  </Step>
  ...
  <Step title="Enable the provider">
    Turn on **Use** for the tested provider you want Craftisle Resume to use.
  </Step>
</Steps>
